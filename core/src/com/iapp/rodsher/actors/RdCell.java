 ...
 * @author Nathan Sweet */
public class RdCell<T extends Actor> implements Poolable {
    ...
    static private RdCell defaults;
    ...
    public RdCell<T> size (Value size) {
    ...
    public RdCell<T> size (Value width, Value height) {
    ...
    /** Sets the minWidth, prefWidth, maxWidth, minHeight, prefHeight, and maxHeight to the specified value. */
    public RdCell<T> size (float size) {
        size(Fixed.valueOf(size));
        return this;
    }

    /** Sets the minWidth, prefWidth, maxWidth, minHeight, prefHeight, and maxHeight to the specified values. */
    public RdCell<T> size (float width, float height) {
        size(Fixed.valueOf(width), Fixed.valueOf(height));
        return this;
    }

    /** Sets the minWidth, prefWidth, and maxWidth to the specified value. */
    public RdCell<T> width (Value width) {
        if (width == null) throw new IllegalArgumentException("width cannot be null.");
        minWidth = width;
        prefWidth = width;
        maxWidth = width;
    ...
    /** Sets the minWidth, prefWidth, and maxWidth to the specified value. */
    public RdCell<T> width (float width) {
        width(Fixed.valueOf(width));
        return this;
    }

    /** Sets the minHeight, prefHeight, and maxHeight to the specified value. */
    public RdCell<T> height (Value height) {
        if (height == null) throw new IllegalArgumentException("height cannot be null.");
        minHeight = height;
        prefHeight = height;
        maxHeight = height;
    ...
    /** Sets the minHeight, prefHeight, and maxHeight to the specified value. */
    public RdCell<T> height (float height) {
        height(Fixed.valueOf(height));
        return this;
    }

    /** Sets the minWidth and minHeight to the specified value. */
    public RdCell<T> minSize (Value size) {
        if (size == null) throw new IllegalArgumentException("size cannot be null.");
        minWidth = size;
        minHeight = size;
        return this;
    ...
    public RdCell<T> minSize (Value width, Value height) {
        if (width == null) throw new IllegalArgumentException("width cannot be null.");
        if (height == null) throw new IllegalArgumentException("height cannot be null.");
        minWidth = width;
        minHeight = height;
    ...
    public RdCell<T> minWidth (Value minWidth) {
        if (minWidth == null) throw new IllegalArgumentException("minWidth cannot be null.");
        this.minWidth = minWidth;
        return this;
    }

    public RdCell<T> minHeight (Value minHeight) {
    ...
    /** Sets the minWidth and minHeight to the specified value. */
    public RdCell<T> minSize (float size) {
        minSize(Fixed.valueOf(size));
        return this;
    }

    /** Sets the minWidth and minHeight to the specified values. */
    public RdCell<T> minSize (float width, float height) {
        minSize(Fixed.valueOf(width), Fixed.valueOf(height));
        return this;
    }

    public RdCell<T> minWidth (float minWidth) {
        this.minWidth = Fixed.valueOf(minWidth);
        return this;
    }

    public RdCell<T> minHeight (float minHeight) {
        this.minHeight = Fixed.valueOf(minHeight);
        return this;
    }

    /** Sets the prefWidth and prefHeight to the specified value. */
    public RdCell<T> prefSize (Value size) {
        if (size == null) throw new IllegalArgumentException("size cannot be null.");
        prefWidth = size;
        prefHeight = size;
        return this;
    ...
    public RdCell<T> prefSize (Value width, Value height) {
        if (width == null) throw new IllegalArgumentException("width cannot be null.");
        if (height == null) throw new IllegalArgumentException("height cannot be null.");
        prefWidth = width;
        prefHeight = height;
    ...
    public RdCell<T> prefWidth (Value prefWidth) {
        if (prefWidth == null) throw new IllegalArgumentException("prefWidth cannot be null.");
        this.prefWidth = prefWidth;
        return this;
    }

    public RdCell<T> prefHeight (Value prefHeight) {
    ...
    /** Sets the prefWidth and prefHeight to the specified value. */
    public RdCell<T> prefSize (float width, float height) {
        prefSize(Fixed.valueOf(width), Fixed.valueOf(height));
        return this;
    }

    /** Sets the prefWidth and prefHeight to the specified values. */
    public RdCell<T> prefSize (float size) {
        prefSize(Fixed.valueOf(size));
        return this;
    }

    public RdCell<T> prefWidth (float prefWidth) {
        this.prefWidth = Fixed.valueOf(prefWidth);
        return this;
    }

    public RdCell<T> prefHeight (float prefHeight) {
    ...
    public RdCell<T> maxSize (Value size) {
        if (size == null) throw new IllegalArgumentException("size cannot be null.");
        maxWidth = size;
        maxHeight = size;
        return this;
    ...
    public RdCell<T> maxSize (Value width, Value height) {
        if (width == null) throw new IllegalArgumentException("width cannot be null.");
        if (height == null) throw new IllegalArgumentException("height cannot be null.");
        maxWidth = width;
        maxHeight = height;
    ...
    public RdCell<T> maxWidth (Value maxWidth) {
    ...
    public RdCell<T> maxHeight (Value maxHeight) {
    ...
    /** Sets the maxWidth and maxHeight to the specified value. If the max size is 0, no maximum size is used. */
    public RdCell<T> maxSize (float size) {
        maxSize(Fixed.valueOf(size));
        return this;
    }

    /** Sets the maxWidth and maxHeight to the specified values. If the max size is 0, no maximum size is used. */
    public RdCell<T> maxSize (float width, float height) {
        maxSize(Fixed.valueOf(width), Fixed.valueOf(height));
        return this;
    }

    /** If the maxWidth is 0, no maximum width is used. */
    public RdCell<T> maxWidth (float maxWidth) {
        this.maxWidth = Fixed.valueOf(maxWidth);
        return this;
    }

    /** If the maxHeight is 0, no maximum height is used. */
    public RdCell<T> maxHeight (float maxHeight) {
        this.maxHeight = Fixed.valueOf(maxHeight);
        return this;
    }

    /** Sets the spaceTop, spaceLeft, spaceBottom, and spaceRight to the specified value. */
    public RdCell<T> space (Value space) {
    ...
    public RdCell<T> space (Value top, Value left, Value bottom, Value right) {
    ...
    public RdCell<T> space (float space) {
    ...
    public RdCell<T> space (float top, float left, float bottom, float right) {
    ...
    /** The space cannot be < 0. */
    public RdCell<T> spaceTop (float spaceTop) {
    ...
    /** The space cannot be < 0. */
    public RdCell<T> spaceLeft (float spaceLeft) {
    ...
    /** The space cannot be < 0. */
    public RdCell<T> spaceBottom (float spaceBottom) {
    ...
    /** The space cannot be < 0. */
    public RdCell<T> spaceRight (float spaceRight) {
    ...
    public RdCell<T> pad (Value top, Value left, Value bottom, Value right) {
        if (top == null) throw new IllegalArgumentException("top cannot be null.");
        if (left == null) throw new IllegalArgumentException("left cannot be null.");
        if (bottom == null) throw new IllegalArgumentException("bottom cannot be null.");
        if (right == null) throw new IllegalArgumentException("right cannot be null.");
    ...
    /** Sets the padTop, padLeft, padBottom, and padRight to the specified value. */
    public RdCell<T> pad (float pad) {
        pad(Fixed.valueOf(pad));
        return this;
    }

    public RdCell<T> pad (float top, float left, float bottom, float right) {
        pad(Fixed.valueOf(top), Fixed.valueOf(left), Fixed.valueOf(bottom), Fixed.valueOf(right));
        return this;
    }

    public RdCell<T> padTop (float padTop) {
        this.padTop = Fixed.valueOf(padTop);
        return this;
    }

    public RdCell<T> padLeft (float padLeft) {
        this.padLeft = Fixed.valueOf(padLeft);
        return this;
    }

    public RdCell<T> padBottom (float padBottom) {
        this.padBottom = Fixed.valueOf(padBottom);
        return this;
    }

    public RdCell<T> padRight (float padRight) {
        this.padRight = Fixed.valueOf(padRight);
        return this;
    }

    /** Sets fillX and fillY to 1. */
    public RdCell<T> fill () {
        fillX = onef;
        fillY = onef;
        return this;
    }
    ...
    /** Sets fillX to 1. */
    public RdCell<T> fillX () {
        fillX = onef;
        return this;
    }

    /** Sets fillY to 1. */
    public RdCell<T> fillY () {
        fillY = onef;
        return this;
    }

    public RdCell<T> fill (float x, float y) {
        fillX = x;
        fillY = y;
        return this;
    }
    ...
    public RdCell<T> fill (boolean x, boolean y) {
        fillX = x ? onef : zerof;
        fillY = y ? onef : zerof;
        return this;
    }
    ...
    /** Sets fillX and fillY to 1 if true, 0 if false. */
    public RdCell<T> fill (boolean fill) {
    ...
    /** Sets expandX to 1. */
    public RdCell<T> expandX () {
        expandX = onei;
        return this;
    }

    /** Sets expandY to 1. */
    public RdCell<T> expandY () {
        expandY = onei;
        return this;
    }

    public RdCell<T> expand (int x, int y) {
        expandX = x;
        expandY = y;
        return this;
    }
    ...
    public RdCell<T> expand (boolean x, boolean y) {
        expandX = x ? onei : zeroi;
        expandY = y ? onei : zeroi;
        return this;
    }

    public RdCell<T> colspan (int colspan) {
        this.colspan = colspan;
        return this;
    }

    /** Sets uniformX and uniformY to true. */
    public RdCell<T> uniform () {
    ...
    public RdCell<T> uniformX () {
        uniformX = Boolean.TRUE;
        return this;
    }

    /** Sets uniformY to true. */
    public RdCell<T> uniformY () {
        uniformY = Boolean.TRUE;
        return this;
    }

    public RdCell<T> uniform (boolean uniform) {
        uniformX = uniform;
        uniformY = uniform;
        return this;
    }

    public RdCell<T> uniform (boolean x, boolean y) {
        uniformX = x;
        uniformY = y;
        return this;
    }
    ...
    void set (RdCell rdCell) {
        minWidth = rdCell.minWidth;
        minHeight = rdCell.minHeight;
        prefWidth = rdCell.prefWidth;
        prefHeight = rdCell.prefHeight;
        maxWidth = rdCell.maxWidth;
        maxHeight = rdCell.maxHeight;
        spaceTop = rdCell.spaceTop;
        spaceLeft = rdCell.spaceLeft;
        spaceBottom = rdCell.spaceBottom;
        spaceRight = rdCell.spaceRight;
        padTop = rdCell.padTop;
        padLeft = rdCell.padLeft;
        padBottom = rdCell.padBottom;
        padRight = rdCell.padRight;
        fillX = rdCell.fillX;
        fillY = rdCell.fillY;
        align = rdCell.align;
        expandX = rdCell.expandX;
        expandY = rdCell.expandY;
        colspan = rdCell.colspan;
        uniformX = rdCell.uniformX;
        uniformY = rdCell.uniformY;
    }

    void merge (@Null RdCell rdCell) {
        if (rdCell == null) return;
        if (rdCell.minWidth != null) minWidth = rdCell.minWidth;
        if (rdCell.minHeight != null) minHeight = rdCell.minHeight;
        if (rdCell.prefWidth != null) prefWidth = rdCell.prefWidth;
        if (rdCell.prefHeight != null) prefHeight = rdCell.prefHeight;
        if (rdCell.maxWidth != null) maxWidth = rdCell.maxWidth;
        if (rdCell.maxHeight != null) maxHeight = rdCell.maxHeight;
        if (rdCell.spaceTop != null) spaceTop = rdCell.spaceTop;
        if (rdCell.spaceLeft != null) spaceLeft = rdCell.spaceLeft;
        if (rdCell.spaceBottom != null) spaceBottom = rdCell.spaceBottom;
        if (rdCell.spaceRight != null) spaceRight = rdCell.spaceRight;
        if (rdCell.padTop != null) padTop = rdCell.padTop;
        if (rdCell.padLeft != null) padLeft = rdCell.padLeft;
        if (rdCell.padBottom != null) padBottom = rdCell.padBottom;
        if (rdCell.padRight != null) padRight = rdCell.padRight;
        if (rdCell.fillX != null) fillX = rdCell.fillX;
        if (rdCell.fillY != null) fillY = rdCell.fillY;
        if (rdCell.align != null) align = rdCell.align;
        if (rdCell.expandX != null) expandX = rdCell.expandX;
        if (rdCell.expandY != null) expandY = rdCell.expandY;
        if (rdCell.colspan != null) colspan = rdCell.colspan;
        if (rdCell.uniformX != null) uniformX = rdCell.uniformX;
        if (rdCell.uniformY != null) uniformY = rdCell.uniformY;
    }
