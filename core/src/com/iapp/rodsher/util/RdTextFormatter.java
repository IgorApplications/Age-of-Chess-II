...
/** {@code TextFormatter} is used by {@link com.badlogic.gdx.utils.I18NBundle} to perform argument replacement.
 *
 * @author davebaol */
class RdTextFormatter {

    private MessageFormat messageFormat;
    private StringBuilder buffer;

    public RdTextFormatter (Locale locale, boolean useMessageFormat) {
     ...
     * <p>
     * If this {@code TextFormatter} has been instantiated with {@link #RdTextFormatter(Locale, boolean) TextFormatter(locale, true)}
     ...
     * <p>
     * On the contrary, if this {@code TextFormatter} has been instantiated with {@link #RdTextFormatter(Locale, boolean)
