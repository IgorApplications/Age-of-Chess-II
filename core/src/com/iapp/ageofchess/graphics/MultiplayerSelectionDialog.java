...
public class MultiplayerSelectionDialog extends RdDialog {

    private final MultiplayerEngineController controller;
    private ImageButton queen, rook, bishop, knight;
    private Consumer<TypePiece> selectionListener = typePiece -> {};

    public MultiplayerSelectionDialog(String title, RdDialogStyle style, MultiplayerEngineController controller) {
        super(title, style);
