...
import com.iapp.ageofchess.multiplayer.Gender;
...
public final class SettingsUtil {
    ...
    public static String defineColor() {
        ...
        if (ChessConstants.localData.getPieceColor() == com.iapp.ageofchess.chess_engine.Color.BLACK) return strings.get("black");
        return strings.get("white");
    }

    public static String defineColor(com.iapp.ageofchess.chess_engine.Color color) {
        var strings = RdApplication.self().getStrings();

        if (color == com.iapp.ageofchess.chess_engine.Color.BLACK) return strings.get("black");
        return strings.get("white");
    }
    ...
    public static  com.iapp.ageofchess.chess_engine.Color defineColor(String upperColor) {
        var strings = RdApplication.self().getStrings();
        ...
        if (upperColor.contains(strings.get("white")))
            ...
            return com.iapp.ageofchess.chess_engine.Color.BLACK;
    ...
    public static com.iapp.ageofchess.chess_engine.Color reverse(com.iapp.ageofchess.chess_engine.Color source) {
        return source == com.iapp.ageofchess.chess_engine.Color.BLACK ? com.iapp.ageofchess.chess_engine.Color.WHITE : com.iapp.ageofchess.chess_engine.Color.BLACK;
    }
