...
public class RdI18NBundle {
    ...
    public ObjectMap<String, String> getProperties() {
        return new ObjectMap<>(properties);
    }
    ...
    public static RdI18NBundle createBundle (FileHandle baseFileHandle) {
     ...
     * @exception MissingResourceException if no bundle for the specified base file handle can be found */
    public static RdI18NBundle createBundle (FileHandle baseFileHandle, Locale locale) {
     ...
     * @exception MissingResourceException if no bundle for the specified base file handle can be found */
    public static RdI18NBundle createBundle (FileHandle baseFileHandle, String encoding) {
     ...
     *               <code>null</code>
     * @exception MissingResourceException if no bundle for the specified base file handle can be found */
    public static RdI18NBundle createBundle (FileHandle baseFileHandle, Locale locale, String encoding) {
        return createBundleImpl(baseFileHandle, locale, encoding);
    }

    private static RdI18NBundle createBundleImpl (FileHandle baseFileHandle, Locale locale, String encoding) {
        if (baseFileHandle == null || locale == null || encoding == null) throw new NullPointerException();

        RdI18NBundle bundle;
        RdI18NBundle baseBundle = null;
    ...
    private static RdI18NBundle loadBundleChain (FileHandle baseFileHandle, String encoding, List<Locale> candidateLocales,
                                                                      int candidateIndex, RdI18NBundle baseBundle) {
        Locale targetLocale = candidateLocales.get(candidateIndex);
        RdI18NBundle parent = null;
    ...
    private static RdI18NBundle loadBundle (FileHandle baseFileHandle, String encoding, Locale targetLocale) {
        RdI18NBundle bundle = null;
        Reader reader = null;
        try {
            FileHandle fileHandle = toFileHandle(baseFileHandle, targetLocale);
            if (checkFileExistence(fileHandle)) {
                // Instantiate the bundle
                bundle = new RdI18NBundle();
